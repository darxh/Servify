...
import BookingModal from "../../features/bookings/components/BookingModal"; // 2. Import the Modal
    ...
    <div className="bg-white">
      <header className="border-b bg-white p-4">
        <div className="mx-auto max-w-7xl">
          <Link
            to="/"
            className="flex w-fit items-center gap-2 text-sm font-medium text-gray-600 hover:text-blue-600"
          >
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900">
                    {service.provider?.name || "Expert Provider"}
                  </p>
